namespace AdventOfCode.Tests.D5
{
    ...
    {
        private static string sample = @"FFFBBFBLLR
BFBBBFFRLR
BFBBBBFLRR
BBFBFFFLLR
BBFBFBFLLL
...
FFBBFBFRRR";
        ...
        public void ShouldDecodeCorrectly()
        {
            ...
            var pass = decoder.Decode("FBFBBFFRLR");

            pass.Row.Should().Be(44);
            pass.Column.Should().Be(5);
        ...
        public void Run()
        {
            var d5 = new BinaryBoarding();
            d5.GetHighestSeatid(sample).Should().Be(906);
        }
    }
}