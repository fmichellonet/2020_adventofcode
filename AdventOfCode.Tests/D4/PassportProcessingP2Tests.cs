namespace AdventOfCode.Tests.D4
{
    ...
    public class PassportProcessingP2Tests
    {
        private const string puzzle = @"byr:1971
eyr:2039
...
pid:745302991 byr:1969 hcl:#7394c7";
        ...
        {
            var sample = @"pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f";

            var validator = new ValidFieldsPassportValidator();

            var d4 = new PassportProcessing(validator);
            var passport = d4.Map(sample).First();
        ...
        {
            var sample = @"pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:2003
hcl:#623a2f";
        ...
        [TestCase("190", false)]
        public void HeightValidation(string height, bool result)
        {
            var sample = $@"pid:087499704 hgt:{height} ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f";
        ...
        public void HairColorValidation(string color, bool result)
        {
            var sample = $@"pid:087499704 hgt:190cm ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:{color}";
        ...
        [Test]
        public void MissingIssueYear()
        {
            var sample = @"pid:087499704 hgt:74in ecl:grn eyr:2030 byr:1980
hcl:#623a2f";
        ...
        [Test]
        public void InvalidOnes()
        {
            var sample = @"eyr:1972 cid:100
...
pid:3556412378 byr:2007";
            ...
            var d4 = new PassportProcessing(new ValidFieldsPassportValidator());
            var res = d4.CountValidPassports(sample);
            res.Should().Be(0);
        }

        [Test]
        public void ValidOnes()
        {
            var sample = @"pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f
...
iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719";
        ...
        {
            var d4 = new PassportProcessing(new ValidFieldsPassportValidator());
            var res = d4.CountValidPassports(puzzle);
            res.Should().Be(186);
        }
    }
}