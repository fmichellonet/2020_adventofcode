namespace AdventOfCode.Tests.D2
{
    ...
    {
        private const string sample = @"13-17 s: ssssssssssssgsssj
7-9 p: pnlzhcppvl
5-6 z: zzbwrv
...
3-12 k: mtcfszkdhkdkd";
        ...
        [Test]
        public void TextShouldBeParsedToPasswordWithPolicy()
        {
            var text = @"1-3 a: abcde";

            var d1 = new PasswordPhilosophy();

            d1.Map(text).Should().BeEquivalentTo(new PasswordWithPolicy
            {
                Letter = 'a',
                Occurrences = new Range(1, 3),
                Password = "abcde"
            });
        }
        ...
        [Test]
        public void ValidShouldRemains()
        {
            var d1 = new PasswordPhilosophy();

            IEnumerable<PasswordWithPolicy> items = new[]
            {
            ...
            d1.Filter(items).Should().NotBeEmpty();
        }

        [Test]
        public void NonValidShouldBeFiltered()
        {
            var d1 = new PasswordPhilosophy();
            ...
            d1.Filter(items).Should().BeEmpty();
        }

        [Test]
        public void Run()
        {
            var d2 = new PasswordPhilosophy();
            var res = d2.CountValidPassword(sample);
        }
    }
}